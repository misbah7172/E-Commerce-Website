        ...
        <div className="container mx-auto px-4 h-full flex items-center justify-center">
          <div className="w-full max-w-4xl mx-auto space-y-3 md:space-y-8 text-center">
            ...
            <div className="space-y-2 md:space-y-6">
              <h1 className="text-2xl md:text-6xl lg:text-8xl font-bold text-gray-900 leading-tight tracking-tight drop-shadow-lg">
                FOR AMAZING
              </h1>
              <h2 className="text-lg md:text-4xl lg:text-6xl font-light text-gray-700 leading-relaxed drop-shadow-md">
                SHOPPING EXPERIENCE
              </h2>
            </div>
            ...
            <div className="max-w-2xl mx-auto">
              <p className="text-xs md:text-2xl lg:text-3xl text-gray-700 font-light leading-relaxed drop-shadow-sm text-center">
              ...
              <div className="flex justify-center">
                <Link href="/products">
                  <Button className="mt-3 md:mt-12 bg-black text-white hover:bg-gray-800 px-4 md:px-12 py-2 md:py-6 text-sm md:text-xl lg:text-2xl font-medium rounded-none shadow-xl">
                    VISIT OUR SHOP
                  </Button>
                </Link>
              </div>
