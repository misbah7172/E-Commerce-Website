    ...
    <div className="min-h-screen bg-white">
      ...
      <BackgroundSlider className="h-64 md:h-screen">
        <div className="container mx-auto px-4 h-full flex items-center justify-center">
          <div className="w-full max-w-4xl mx-auto space-y-4 md:space-y-8 text-center">
            {/* Main Headline - Updated Sep 5, 2025 */}
            <div className="space-y-2 md:space-y-6">
              <h1 className="text-3xl md:text-6xl lg:text-8xl font-bold text-gray-900 leading-tight tracking-tight drop-shadow-lg">
                FOR AMAZING
              </h1>
              <h2 className="text-xl md:text-4xl lg:text-6xl font-light text-gray-700 leading-relaxed drop-shadow-md">
                SHOPPING EXPERIENCE
              </h2>
            </div>
            ...
            <div className="max-w-2xl mx-auto">
              <p className="text-sm md:text-2xl lg:text-3xl text-gray-700 font-light leading-relaxed drop-shadow-sm text-center">
              ...
              <div className="flex justify-center">
                <Link href="/products">
                  <Button className="mt-4 md:mt-12 bg-black text-white hover:bg-gray-800 px-6 md:px-12 py-3 md:py-6 text-base md:text-xl lg:text-2xl font-medium rounded-none shadow-xl">
                    VISIT OUR SHOP
                  </Button>
                </Link>
              </div>
